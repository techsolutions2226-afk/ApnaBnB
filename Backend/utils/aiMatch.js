...
const buildPrompt = (property, requirement) =>
  [
    ...
    'Consider budget fit, area/locality, property type, size (Marla/Kanal/Sq.Ft are interchangeable — 1 Marla ≈ 272 Sq.Ft), bedrooms, bathrooms, and softer signals in the text (e.g. "near park", "family home", "corner plot").',
